...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Smartblockscoin Core smartblockscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  smartblockscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smartblockscoin transaction") + "\n" +
                               "  smartblockscoin-tx [options] -create [commands]   " + _("Create hex-encoded smartblockscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded smartblockscoin transaction
