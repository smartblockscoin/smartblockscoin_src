...
#ifndef Smartblockscoin_ZSBCWALLET_H
#define Smartblockscoin_ZSBCWALLET_H
...
public:
    CzSBCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSBC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSBC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //Smartblockscoin_ZSBCWALLET_H
