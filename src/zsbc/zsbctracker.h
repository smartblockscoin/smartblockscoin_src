...
#ifndef Smartblockscoin_ZSBCTRACKER_H
#define Smartblockscoin_ZSBCTRACKER_H
...
public:
    CzSBCTracker(std::string strWalletFile);
    ~CzSBCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSBCWallet* zSBCWallet = NULL);
...
#endif //Smartblockscoin_ZSBCTRACKER_H
