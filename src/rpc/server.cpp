...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Smartblockscoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Smartblockscoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Smartblockscoin features */
        {"smartblockscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"smartblockscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"smartblockscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"smartblockscoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"smartblockscoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"smartblockscoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"smartblockscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"smartblockscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"smartblockscoin", "startmasternode", &startmasternode, true, true, false},
        {"smartblockscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"smartblockscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"smartblockscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"smartblockscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"smartblockscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"smartblockscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"smartblockscoin", "preparebudget", &preparebudget, true, true, false},
        {"smartblockscoin", "submitbudget", &submitbudget, true, true, false},
        {"smartblockscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"smartblockscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"smartblockscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"smartblockscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"smartblockscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"smartblockscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"smartblockscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"smartblockscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"smartblockscoin", "mnsync", &mnsync, true, true, false},
        {"smartblockscoin", "spork", &spork, true, true, false},
        {"smartblockscoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsbcseed", &getzsbcseed, false, false, true},
        {"zerocoin", "setzsbcseed", &setzsbcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsbc", &searchdzsbc, false, false, true},
        {"zerocoin", "dzsbcstate", &dzsbcstate, false, false, true},
...
{
    return "> smartblockscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17017/\n";
}
