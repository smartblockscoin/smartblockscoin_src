...
/** Utility functions used by the Smartblockscoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Smartblockscoin addresses in monospace font
...
// Parse "smartblockscoin:" URI into recipient object, return true on successful parsing
