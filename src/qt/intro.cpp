...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Smartblockscoin Core"),
     ...
     * override -datadir in the smartblockscoin.conf file in the default data directory
     * (to be consistent with smartblockscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
