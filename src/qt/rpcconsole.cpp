                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSBCPathCustom = GetArg("-zsbcbackuppath", "");
    ...
    if(!strzSBCPathCustom.empty()) {
        ui->wallet_customzsbcbackuppath->setText(QString::fromStdString(strzSBCPathCustom));
        ui->wallet_customzsbcbackuppath_label->setVisible(true);
        ui->wallet_customzsbcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSBCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Smartblockscoin RPC console.") + "<br>" +
