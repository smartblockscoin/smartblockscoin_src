...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SBC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeSmartblockscoinAmount"))
        SoftSetArg("-anonymizesmartblockscoinamount", settings.value("nAnonymizeSmartblockscoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in smartblockscoin.cpp during shotdown to also remove the window positions
