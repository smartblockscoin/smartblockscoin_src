...
EXCLUDE = [
    # auto generated:
    'src/qt/smartblockscoinstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Smartblockscoin developers\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Smartblockscoin developers'
...
Arguments:
    <base_directory> - The base directory of a smartblockscoin source code repository.
"""
