Contributing to Smartblockscoin Core
============================

The Smartblockscoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/smartblockscoin-project/smartblockscoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Smartblockscoin Core project, and is not to be
confused with overall Smartblockscoin Network Protocol consensus changes.

Whether a pull request is merged into Smartblockscoin Core rests with the project merge
...
Patches that change Smartblockscoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Smartblockscoin consensus, it must have been
...
The project leader is the release manager for each Smartblockscoin Core release.
